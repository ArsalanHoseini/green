						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="woo_pr_detail">
								...
								<div class="woo_pr_price">
									...
									<h3>@php echo $product->price - ($product->discount * 0.1)    @endphp تومان<span class="org_price">{{$product->price}} تومان</span></h3>
									@else
								...
								<div class="pr_info_prefix grocery_style mb-3">
									...
									<div class="cart_sku_preflix">
										...
										<div class="sku_preflix_last">
											...
											@elseif($product->count <= 5 && $product->count > 0)
											<span class="text-danger">تعداد {{$product->count}} موجود است</span>
											@else
