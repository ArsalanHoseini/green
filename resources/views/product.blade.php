					...
					<div class="row align-items-center">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="text-center">
								<h2 class="breadcrumbs_title">آناناس نوتریک</h2>
								<nav aria-label="breadcrumb">
								  <ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">مردان</a></li>
									<li class="breadcrumb-item"><a href="#">میوه های تازه</a></li>
									<li class="breadcrumb-item active" aria-current="page">آناناس</li>
								  </ol>
								</nav>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="sp-loading"><img src="assets/img/detail/detail-6.png" alt=""><br>بارگیری تصاویر</div>
							<div class="sp-wrap">
								<a href="assets/img/detail/detail-6.png"><img src="assets/img/detail/detail-6.png" alt=""></a>
								<a href="assets/img/detail/detail-7.png"><img src="assets/img/detail/detail-7.png" alt=""></a>
								<a href="assets/img/detail/detail-8.png"><img src="assets/img/detail/detail-8.png" alt=""></a>
								<a href="assets/img/detail/detail-9.png"><img src="assets/img/detail/detail-9.png" alt=""></a>
								<a href="assets/img/detail/detail-10.png"><img src="assets/img/detail/detail-10.png" alt=""></a>
								<a href="assets/img/detail/detail-11.png"><img src="assets/img/detail/detail-11.png" alt=""></a>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="woo_pr_detail">
								...
								<div class="woo_cats_wrps">
									<a href="#" class="woo_pr_cats">میوه های تازه</a>
									<span class="woo_pr_trending">پرطرفدار</span>
								</div>
								<h2 class="woo_pr_title">آناناس تازه نوتریک</h2>
								...
								<div class="pr_info_prefix grocery_style mb-3">
									...
									<div class="cart_sku_preflix">
										...
										<div class="sku_preflix_last">
											<span class="text-success">در انبار</span>
										</div>
									</div>
								...
								<div class="woo_btn_action">
									<div class="col-12 col-lg-auto">
										<input type="number" class="form-control qua_pr mb-2" value="1" />
									</div>
									<div class="col-12 col-lg-auto">
								...
								<div class="tab-content" id="myTabContent">
									...
									<div class="tab-pane fade" id="information" role="tabpanel" aria-labelledby="information-tab" aria-expanded="false">
										...
										<div class="product_meta">
											<span class="sku_wrapper">شماره محصول: <span class="sku">1001</span></span>
											<span class="posted_in">دسته بندی:
												<a href="#" rel="tag">صندلی</a>,
												<a href="#" rel="tag">چوب</a>
											</span>
											<span class="tagged_as">برچسب ها:
												<a href="#" rel="tag">صندلی</a>,
												<a href="#" rel="tag">مبلمان</a>
											</span>
										</div>
									</div>
											...
											<div class="review-wrapper-body">
												...
												<div class="row">
													...
													<div class="col-sm-12 form-group">
														<textarea class="form-control height-110" placeholder="تجربه خود را برای ما بگویید..."></textarea>
													</div>
													<div class="col-sm-12">
								...
								<div class="item">
									<div class="woo_product_grid">
										...
										<div class="woo_product_caption center">
											...
											<div class="woo_title">
												<h4 class="woo_pro_title"><a href="detail-1.html">عنوان محصولات</a></h4>
											</div>
											<div class="woo_price">
