                            ...
                            <ul class="nav-menu">
                                ...
                                <li class="active"><a href="#">خانه<span class="submenu-indicator"></span></a>
                                    <ul class="nav-dropdown nav-submenu">
                                        <li><a href="#"> برند<span class="submenu-indicator"></span></a>
                                            <ul class="nav-dropdown nav-submenu">
                                                <li><a href="grocery.html">کشت سبز</a></li>
                                                <li><a href="grocery-2.html">بی رقیب</a></li>
                                                <li><a href="grocery-3.html">گلستان</a></li>
                                                <li><a href="grocery-3.html">کاناز</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#"> محصولات فله ای<span class="submenu-indicator"></span></a>
                                        </li>
                                ...
                                {{-- <li><a href="{{route('categorylist')}}">دسته بندی<span class="submenu-indicator"></span></a>
                                    <ul class="nav-dropdown nav-submenu">
                                        @foreach(App\Models\Category::GetAll() as $item)
                                            <li><a href="/categories/{{$item->slug}}">{{$item->nameinpersian}}</a></li>
                                        @endforeach
                                        @if (App\Models\Category::GetCount() >= 7)
                                            <li><a href="/categories">مشاهده همه ی دسته بندی ها...</a></li>
                                        @endif
                                    </ul>
                                </li> --}}
                                </li>
                                ...
                                <li><a href="#">صفحه های کاربردی<span class="submenu-indicator"></span></a>
                                    <ul class="nav-dropdown nav-submenu">
                                ...
                                <li><a href="#">تماس با ما<span class="submenu-indicator"></span></a>
        ...
        <div class="footer-middle">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="footer_widget">
                            ...
                            <div class="address_infos">
                                <ul>
                                    <li><i class="ti-home theme-cl"></i>ایران ، شیراز ، پاسداران ، کوچه 66  ،<br> ساختمان آیهان 7 پلاک  396</li>
                    ...
                    <div class="col-lg-2 col-md-2">
                        <div class="footer_widget">
                            <a referrerpolicy="origin" target="_blank" href="https://trustseal.enamad.ir/?id=316661&amp;Code=2sEHL7W05YiaftKK85AS"><img referrerpolicy="origin" src="https://Trustseal.eNamad.ir/logo.aspx?id=316661&amp;Code=2sEHL7W05YiaftKK85AS" alt="" style="cursor:pointer" id="2sEHL7W05YiaftKK85AS"></a>
                        </div>
                    </div>
                    ...
                    @else
                        ...
                        <div class="cart_selected_single">
                            ...
                            <div class="cart_selected_single_caption">
                                ...
                                <span class="numberof_item"> تومان</span>
